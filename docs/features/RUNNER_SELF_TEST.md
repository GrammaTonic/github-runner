...
This document explains how to smoke-test that self-hosted runners (standard and Chrome) accept GitHub Actions jobs and can execute a simple test workflow. All runner images are now based on `ubuntu:resolute` (25.10 pre-release) and support the latest GitHub Actions runner version.
