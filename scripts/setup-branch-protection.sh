...
echo "   1. Work on the 'develop' branch for all development"
echo "   2. Create feature branches from 'develop' (feature/name or hotfix/name)"
echo "   3. Create PR from feature branch → develop for code review"
echo "   4. Merge to develop after approval"
echo "   5. Create PR from develop → main for releases"
echo "   6. Direct pushes to main are blocked"
echo
